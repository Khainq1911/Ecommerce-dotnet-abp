        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p-button label="Sign In" styleClass="w-full" (click)="handleSubmit()"></p-button>
            </div>
          </div>
        </div>
      </div>
  ...
  handleSubmit() {
    ...
    this.loginService.login(body).subscribe({
      next: async res => {
        ...
        // Load permissions và user info
        // Load permissions, nhưng không block nếu thất bại
        this.loginService.loadPermissions().subscribe({
          next: () => {
            this.messageService.add({
              severity: 'success',
              summary: 'Thành công',
          ...
          error: err => {
            // Vẫn cho phép đăng nhập nếu load permissions thất bại
            // Chỉ log lỗi, không hiển thị thông báo vì đã được error interceptor xử lý
            console.warn('Không thể load permissions sau khi login:', err);
            this.messageService.add({
              severity: 'success',
              summary: 'Thành công',
              detail: 'Đăng nhập thành công',
